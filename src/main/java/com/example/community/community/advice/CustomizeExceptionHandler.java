...
HttpServletRequest request,
 Throwable e, Model model, HttpServletRequest request, HttpServletResponse response) {
...
new ResponseEntity<>(new CustomErrorType(status.value(), ex.getMessage()), status)
        }
